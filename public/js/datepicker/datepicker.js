    ...
    _buildEvents: function _buildEvents() {
      ...
      this._secondaryEvents = [[this.picker, {
        ...
        mousedown: $.proxy(function (e) {
          ...
          var _size = function _size(o) {
            return o.length || o.size && o.size();
          };

          if (!(this.element.is(e.target) || _size(this.element.find(e.target)) || this.picker.is(e.target) || _size(this.picker.find(e.target)))) {
            this.hide();
          }
        }, this)
      }]];
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ProjectAccountRice\resources\js\datepicker.js */"./resources/js/datepicker.js");
