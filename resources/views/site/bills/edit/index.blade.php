...
<div class="card" style="font-family: kanit;">
    <div class="card-header">
        <div class="row">
            <div class="col-12">
                <h4>แก้ไขบัญชี <b><?php echo isset($date_get) ? $date_get : null ?></b></h4>
            </div>
        </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                <?= Form::open(array('route' => 'bills.dataEdit','class' => 'form-inline')) ?>
        ...
        @if(isset($data))
            ...
            <div class="dataTables_wrapper dt-bootstrap4">
                <?= Form::open(array('route' => 'bills.update')) ?>
                    ...
                    <div class="dataTables_wrapper dt-bootstrap4">
                        @include('site/bills/edit/pagination')
                    </div>
                    
                <?= Form::close() ?> 
            </div>
            @else
                <div class="card-header h3 text-center">ไม่มีข้อมูลบัญชี <b><?php echo $date_get ?></b> <img src="https://i.pinimg.com/originals/f6/97/b5/f697b513c92e365c781d1dce461e18f1.gif" alt="การ์ตูน" width="50px"> </div>
            @endif
        @endif
...
<script src="{{ asset('/js/site/bills/edit/index.js') }}" type="text/javascript"></script>
@endsection
